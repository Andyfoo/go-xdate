...
func Test1(t *testing.T) {
	...
	fmt.Println(Unix(1588009973, 0).Format("2006-01-02 15:04:05"))
	fmt.Println(PFormatConv("Y-m-d H:i:s"))
	fmt.Println(Now().PFormat("Y-m-d H:i:s"))
	fmt.Println(Now().Format(YMD))
	fmt.Println(Now().UTC().Format(TT))
	fmt.Println(Now().UTC().PFormat("Y-m-d H:i:s"))
	fmt.Println(Now().Unix())
	fmt.Println(Now().UnixMilli())
	fmt.Println(Now().UnixNano())
	fmt.Println(Now().Weekday())
	fmt.Println(Now().WeekdayStr(1))
	fmt.Println(Now().UTC().Local().Format(TT))
...
func Test2(t *testing.T) {
	...
	t1 := Now()
	fmt.Println(t1.Offset(DateField_YEAR, 3).UTC().DateTimeStr())
	fmt.Println(t1.Offset(DateField_MONTH, 3).PFormat("Y-m-d H:i:s"))
